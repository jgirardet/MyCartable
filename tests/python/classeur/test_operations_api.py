...
# @pytest.fixture
# def to(dao, fk):
#     x = fk.f_additionSection(string="9+8")
...
#
#     def test_load_params(self, fk, qtbot, uim):
#         from package.database_object import DatabaseObject
#
#         OperationModel.ddb = DatabaseObject(fk.db, uim)
#         op = OperationModel()
#         op.sectionId = str(uuid.uuid4())
#         assert op.sectionId is None, "should not be set if not in databse"
#
#         td = fk.f_additionSection(string="9+8", td=True)
#
...
#         ],
#     )
#     def test_addRetenues(self, cur, r1, r2, dao, fk):
#         # '',  '', '2', '', '', '5', '', '', '4', '', //9
#         # '-', '', '1', '', '', '4', '', '', '1', '', //19
#         # '',  '', '',  '', '', '',  '', '', '',  ''] //29
...
#             ddb = dao
#
#         tss = fk.f_soustractionSection("254-141")
#         mod = Sous()
...
#         ],
#     )
#     def test_addRetenuesVirgule(self, cur, r1, r2, dao, fk):
#         # ' ', ' ', '1', ' ', '*', '2', ' ', ',', '*', '0', ' ', '*', '0', ' ', '*', '0', ' ', //16
#         # '-', ' ', ' ', '*', ' ', '3', '*', ',', ' ', '3', '*', ' ', '4', '*', ' ', '5', ' ',//33
#         # ' ', ' ', '*', ' ', ' ', '*', ' ', ',', ' ', '*', ' ', ' ', '*', ' ', ' ', '*', ' '//50
#         class Sous(SoustractionModel):
#             ddb = dao
#
#         tss = fk.f_soustractionSection("12-3,345")
#         mod = Sous()
#         mod.sectionId = tss.id
#         mod.cursor = cur
#         assert mod.datas[r1] == ""
...
#     def test_addRetenuesNedoitPas(self, cur, r1, r2, dao, fk):
#         class Sous(SoustractionModel):
#             ddb = dao
#
#         tss = fk.f_soustractionSection("12-3,345")
...
#
#     def test_custom_params_load(self, dao, fk):
...
#
#         a = MultiplicationModel2()
#         x = fk.f_multiplicationSection(string="323*23")
#         a.sectionId = x.id
#         assert a.cursor == 24
#
#
...
#
#         def __call__(self, string):
#             self.f_entry = fk.f_divisionSection(string=string)
