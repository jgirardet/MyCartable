...
#     ],
# )
# def test_preprocess_three_lines(string, res):
#     assert pre_process_three_lines(string) == res
#
#
...
#         ),
#         ("    \n1 + 15 + 1\n", "1 + 15 + 1", [m_un, plus, m_quinze, plus, m_un],),
...
#     ],
# )
# def test_parser_3_lines_to_one_string_to_string(three, string, res):
#     msg = ""
