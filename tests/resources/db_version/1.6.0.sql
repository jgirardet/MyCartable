...
CREATE TABLE "Traduction" (
  ...
  "lexon" UUID NOT NULL REFERENCES "Lexon" ("id") ON DELETE CASCADE,
  "locale" TEXT NOT NULL REFERENCES "Locale" ("id") ON DELETE CASCADE,
...
CREATE INDEX "idx_zonefrise__style" ON "ZoneFrise" ("style");
